...
--atkto1~8，该次攻击/技能针对的目标，可以是全场，直接atktoi[x]可以代表卡牌
    self.bettlereport={
        ...
        round1={
            ...
            attack4={atkfrom='enefront',atktype1='normal',atkto1={myfront=-1555}},
            attack5={atkfrom='enehead',atktype1='normal',atkto1={myfront=-1333}}         
                },
        round2={
            attack1={atkfrom='mymid',atktype1='diewuhonglian',atkto1={enefront=-529,myhead=0,myfront=308},
                                     atktype2='normal',atkto2={enemid=-344}},
            attack2={atkfrom='myhead',atktype1='normal',atkto1={enefront=-762}},
            attack3={atkfrom='myfront',atktype1='normal',atkto1={enemid=-390}},
            attack4={atkfrom='enefront',atktype1='normal',atkto1={myfront=-1777}},
        ...
        round3={
            ...
            attack4={atkfrom='enehead',atktype1='normal',atkto1={myhead=-1555}}
        },
        round4={
            attack1={atkfrom='mymid',atktype1='diewuhonglian',atkto1={enehead=-502,myhead=0,myfront=174},
            ...
            attack4={atkfrom='enehead',atktype1='normal',atkto1={mymid=-1666}}
        },
        round5={attack1={atkfrom='mymid',atktype1='diewuhonglian',atkto1={enehead=-479,myhead=0,myfront=0}}},
        round6=nil,
        round7=nil,
        round8=nil}
--    --战斗，生成战报
...
function Battle:initCard()
    self.battlecard={myhead={typ=Battle.SOLDER_TYPE_INFANTRY,hp=7100,cardname='mycard1.png',atk,def,pos,speed},
                     mymid={typ=Battle.SOLDER_TYPE_HORSE,hp=7700,cardname='mycard2.png',atk,def,pos,speed},
